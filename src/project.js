...
export const catalogGroups = {
  ...
  graduations: [
    ...
    { id: "grade-9-11", title: "После 9 и 11 класса", description: "Программа и оформление согласуются отдельно под площадку, возраст и стиль выпускного.", image: media("graduations/photo-500.jpg") },
  ],
  shows: [
  ...
  services: [
    ...
    { id: "decor", title: "Оформление мероприятий", description: "Воздушные шары, фотозоны и декор площадки от партнёров Арт-Деко.", image: media("services/art-deco/logo.jpg") },
  ],
  programs: [
    ...
    { id: "packages", title: "Любое событие", description: "Соберём программу для вашего повода из героев, шоу и праздничных станций.", image: media("shows/neon/photo-559.jpg") },
  ],
};
...
export const services = [
  star("arthur-pirozhkov", "Артур Пирожков", media("stars/offers/artur-pirozhkov.png"), [media("stars/arthur/cover.png")], media("stars/arthur/performance.m4v"), {
  ...
  star("stas-mikhailov", "Стас Михайлов", media("stars/offers/stas-mikhailov.png"), [media("stars/stas/photo-059.jpg"), media("stars/stas/photo-070.jpg"), media("stars/stas/photo-188.jpg"), media("stars/stas/photo-210.jpg"), media("stars/stas/photo-217.jpg")], media("stars/stas/performance.m4v"), {
    short: "Стас с характерными усами и бородкой: душевный музыкальный сюрприз.",
  }),
  star("loboda", "Лобода", media("stars/offers/loboda.png"), [media("stars/loboda-cover.png")], media("stars/shared/loboda-performance.m4v"), {
    short: "Проверенный женский сценический образ Лободы для яркого музыкального сюрприза.",
  }),
  star("kirkorov", "Филипп Киркоров", media("stars/offers/filipp-kirkorov.png"), [media("stars/kirkorov/photo-427.jpg"), media("stars/kirkorov/photo-426.jpg"), media("stars/kirkorov/photo-489.jpg"), media("stars/kirkorov/photo-527.jpg")]),
  star("allegrova", "Ирина Аллегрова", media("stars/offers/irina-allegrova.png"), [media("stars/allegrova/photo-540.jpg")]),
  star("galustyan", "Михаил Галустян", media("stars/offers/mihail-galustyan.png"), [media("stars/shared/galustyan-photo-006.jpg")]),
  star("vlad-a4", "Влад А4", media("stars/offers/vlad-a4.png"), [media("stars/vlad-a4/photo-052.jpg")]),
  star("instasamka", "Инстасамка", media("stars/offers/instasamka.png"), ["./public/media/stars.jpg"], null, { badge: "Образ по запросу", short: "Яркое экспресс-поздравление в образе Инстасамки. Актуальное фото костюма подтвердим перед заказом." }),
  ...
  service({ id: "graduation-grade-9-11", category: "graduations", subgroup: "grade-9-11", title: "Выпускной после 9 и 11 класса", badge: "Старшая школа", duration: "по согласованию", image: media("graduations/photo-500.jpg"), gallery: [media("graduations/photo-500.jpg")], short: "Соберём современный выпускной и оформление под ваш класс, площадку и бюджет.", description: "Подробный сценарий, ведущих, шоу и оформление согласуем индивидуально после обсуждения программы.", includes: ["индивидуальный сценарий", "ведущие и диджей", "шоу на выбор", "оформление площадки"], externalUrl: "https://artdeco-vl.ru/", externalLabel: "Сайт Арт-Деко ↗" }),
  ...
  service({ id: "event-decor", category: "services", subgroup: "decor", title: "Оформление мероприятий", badge: "Партнёрская услуга", duration: "по согласованию", image: media("services/art-deco/logo.jpg"), gallery: [media("services/art-deco/logo.jpg")], short: "Оформление площадки, фотозоны и воздушные композиции от Арт-Деко.", description: "Подберём оформление под повод, площадку и палитру вашего праздника. Детали и визуальную концепцию согласуем заранее.", includes: ["фотозоны", "воздушные композиции", "декор площадки", "индивидуальная концепция"], externalUrl: "https://artdeco-vl.ru/", externalLabel: "Сайт Арт-Деко ↗" }),
  ...
  service({ id: "custom-event", category: "programs", subgroup: "packages", title: "Любое событие", badge: "Соберём под вас", duration: "по согласованию", image: media("shows/neon/photo-559.jpg"), gallery: [media("shows/neon/photo-559.jpg"), media("shows/silver/photo-400.jpg"), media("shows/bubbles/photo-554.jpg")], short: "Подберём героев, шоу и праздничные станции под ваш повод.", description: "День рождения, семейный праздник, корпоратив или любой другой повод — составим программу после короткого обсуждения вашего события.", includes: ["программа под повод", "герои и ведущие", "шоу на выбор", "координация программы"] }),
];
