export const project = {
  name: "Чудо Зайка",
  siteUrl: "https://chydozaika.ru",
  logo: "./public/media/logo.jpg",
  title: "Праздник, который начинается с улыбки",
  lead: "Аниматорское агентство «Чудо Зайка»: детские аниматоры, экспресс-поздравления, шоу и праздничные станции во Владивостоке, Большом Камне, Находке и других городах Приморского края.",
  phone: "+7 (994) 994-04-33",
  phoneHref: "tel:+79949940433",
  telegram: "https://t.me/CongratulationsinPrimorye",
  region: "Владивосток, Большой Камень, Находка и Приморский край",
};
...
export const catalogGroups = {
  ...
  services: [
    ...
    { id: "decor", title: "Оформление мероприятий", description: "Воздушные шары, фотозоны и декор площадки от партнёров Арт-Деко.", image: media("services/art-deco/logo.jpg"), partnerUrl: "https://artdeco-vl.ru/", partnerName: "artdeco-vl.ru" },
  ],
  programs: [
